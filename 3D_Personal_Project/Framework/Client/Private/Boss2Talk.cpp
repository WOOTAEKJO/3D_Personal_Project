...
HRESULT CBoss2Talk::Ready_UI()
{
	...
	if (FAILED(Add_GROUP(TEXT("Boss1"), Add_UI(_float2(vMarkPos.x, vMarkPos.y),
		_float2(200.f, 250.f), UI_PHANTOM_TAG, GO_UICHATBOX_TAG)))) return E_FAIL;
	...
	if (FAILED(Add_GROUP(TEXT("Boss3"), Add_UI(_float2(vMarkPos.x, vMarkPos.y),
		_float2(200.f, 250.f), UI_PHANTOM_TAG, GO_UICHATBOX_TAG)))) return E_FAIL;
	if (FAILED(Add_GROUP(TEXT("Boss3"), Add_UI(_float2(vChatPos.x, vChatPos.y),
		_float2(550.f, 150.f), UI_CHATBOX_TAG, GO_UICHATBOX_TAG)))) return E_FAIL;

	if (FAILED(Add_GROUP(TEXT("Boss4"), Add_UI(_float2(vMarkPos.x, vMarkPos.y),
		_float2(200.f, 250.f), UI_PHANTOM_TAG, GO_UICHATBOX_TAG)))) return E_FAIL;
	if (FAILED(Add_GROUP(TEXT("Boss4"), Add_UI(_float2(vChatPos.x, vChatPos.y),
		_float2(550.f, 150.f), UI_CHATBOX_TAG, GO_UICHATBOX_TAG)))) return E_FAIL;
