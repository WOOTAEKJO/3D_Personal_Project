...
class CHelico_Exhausted_Wake final : public CMonster_State
{
public:
	
private:
	CHelico_Exhausted_Wake();
	virtual	~CHelico_Exhausted_Wake() = default;
...
public:
	static	CHelico_Exhausted_Wake* Create(CGameObject* pGameObject);
