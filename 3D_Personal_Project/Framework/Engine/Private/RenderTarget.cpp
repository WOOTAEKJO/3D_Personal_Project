...
HRESULT CRenderTarget::Ready_Debug(_float fX, _float fY, _float fSizeX, _float fSizeY)
{
	...
	m_matWorld._41 = fX - Viewport.Width * 0.5f;
	m_matWorld._42 = -fY + Viewport.Height * 0.5f;

	return S_OK;
}

HRESULT CRenderTarget::Render_Debug(CShader* pShader, CVIBuffer_Rect* pBuffer)
{
	if (FAILED(pShader->Bind_Matrix("g_matWorld", &m_matWorld)))
		return E_FAIL;
